...
projectArchieve &&
  projectInserter(projectArchieve, projectArray, "project-archive-item");

function projectInserter(element, projectShow, className = "") {
  projectShow.forEach((project) => {
    const html = `
  <div class="project-item ${project.filter} ${className} has_animation">
              <div class="files">
